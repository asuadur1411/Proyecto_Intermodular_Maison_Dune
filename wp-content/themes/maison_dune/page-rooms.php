...
<main id="main" class="site-main">
    ...
    <section class="rooms-dark-intro" style="background-image: linear-gradient(rgba(11, 11, 11, 0.95), rgba(11, 11, 11, 0.95)), url('<?php echo get_template_directory_uri(); ?>/assets/img/estampado-negro-dorado.png');">
        <div class="dark-intro-container">
            <div class="dark-intro-text">
                ...
                <h2>Classic, Supérior &<br>Deluxe Rooms</h2>
    ...
    <section class="rooms-bento-section">
        ...
        <!-- Module 1: Classic Rooms -->
        <div class="luxury-bento-container">
            <!-- 1. Large Format Image (2x2) -->
            ...
            <div class="bento-box bento-text-main">
                ...
                <a href="#book-classic" class="bento-link">
                    Secure your reservation 
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>

            <!-- 3. Dark Specifications Box (1x1) -->
            <div class="bento-box bento-info-dark">
                <h4>Details</h4>
                <ul class="bento-specs">
                    <li><span class="spec-label">Area</span> <span class="spec-value">28 - 35 m²</span></li>
            ...
            <div class="bento-box bento-quote">
                ...
                <span class="quote-author">— Maison Dune Design</span>
            </div>

            <!-- 7. Secondary Visual Detail (1x1) -->
        ...
        <!-- Module 2: Supérior (Reverse Pattern) -->
        <div class="luxury-bento-container reverse">
            <!-- 2. Main Text Box (2x1) -->
            <div class="bento-box bento-text-main">
                <h3>Luminosity and Spaciousness</h3>
                <p>Our Supérior Rooms open their impeccable large windows to the lush botanical gardens or the iconic views of Hivernage. The polished marble floor and opulent noble fabrics create a true atmosphere of palatial luxury.</p>
                <a href="#book-superior" class="bento-link">
                    Secure your reservation 
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
            ...
            <!-- 1. Large Format Image (2x2) -->
            <div class="bento-box bento-image-main">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/habitaciones-3.webp" alt="Supérior Room">
                <div class="bento-badge">Supérior Rooms</div>
            </div>
            ...
            <div class="bento-box bento-info-dark">
                <h4>Details</h4>
                <ul class="bento-specs">
                    <li><span class="spec-label">Area</span> <span class="spec-value">40 - 45 m²</span></li>
            ...
            <!-- 7. Secondary Visual Detail (1x1) -->
            <div class="bento-box bento-image-small">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/luxury_suite_half_screen.png" alt="Supérior Bathroom Detail">
            </div>

            <!-- 6. Quote / Editorial (2x1) -->
            <div class="bento-box bento-quote">
                <p>"More than a room, an elevated sanctuary where light dances, caressing sumptuous textures and impeccable finishes."</p>
                <span class="quote-author">— Exclusive Traveler Guide</span>
            </div>
    ...
    <!-- BANNER RESERVAS -->
    <section class="rooms-booking-cta" style="background-color: #cdb998; background-image: url('');">
