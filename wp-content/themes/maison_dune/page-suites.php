            ...
            <div class="e-wrapper">
                ...
                <div class="e-content-columns">
                    ...
                    <div class="e-col-right">
                        ...
                        <a href="<?php echo esc_url(home_url('/exceptional-suites')); ?>" class="e-btn-lux">
                            Discover Suites 
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="1.5" fill="none" class="e-btn-icon"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </a>
                    </div>
                </div>
            </div>
