...
<div class="restaurant-hero">
    <div class="restaurant-hero-content">
        <h3>All the flavors in</h3>
        <h1>Ziryab</h1>
        <p>The Jewel of the Desert. A sensory journey through the ancestral flavors of Arabia in a modern luxury
            setting.</p>
        <div class="buttons-restaurant">
            <a href="#menu" class="bg">See menu</a>
            <a href="<?php echo esc_url(home_url('/table')); ?>" class="outline">Book a table</a>
        </div>
    </div>

    <div class="restaurant-intro-features">
        ...
        <div class="intro-features-content">
            <div class="intro-feature">
                <svg fill="#ffffff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="SVGRepo_tracer" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                c-5.216-15.841-9.483-33.437-12.73-52.427c3.33,0.211,6.684,0.33,10.066,0.33c33.994,43.775,40.767,36.002,40.767,27.009z 
                ...
                c-0.084,5.522,4.325,10.067,9.847,10.151c0.052,0,0.104,0.001,0.155,0.001c5.451,0,9.912-4.377,9.995-9.848
                ...
                <h3>Pure Origin</h3>
                <div class="line"></div>
                <p>Our pantry is a bridge between two worlds. We import saffron from Iran, sumac from Jordan, and
                    rosewater from Lebanon, combining them with the finest suckling lamb from Segovia and organic
                    vegetables from the Navarrese orchards.
                </p>
            </div>
            <div class="intro-feature">
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                            ...
                            <g id="Icon-Set" sketch:type="MSLayerGroup" transform="translate(-415.000000, -411.000000)"
                                ...
                                <path
                                    ...
                                    id="fire-2" sketch:type="MSShapeGroup"> </path>
                            </g>
                        </g>
                    </g>
                </svg>
                <h3>Alchemy of Fire</h3>
                <div class="line"></div>
                <p>At the heart of our kitchen burns a traditional clay Tandoor oven and an oak charcoal grill. We don't
                    use gas or electricity for main cooking; we believe smoke is another spice.</p>
            </div>
            <div class="intro-feature">
                ...
                <h3>Sacred Hospitality</h3>
                <div class="line"></div>
                <p>For us, 'Ahlan Wa Sahlan' is not just a greeting, it's a commitment. Service at Ziryab

                    follows the ritual of Bedouin hospitality: the guest is king, and their comfort is our highest
                    priority.
                </p>
            </div>
        </div>
...
<section class="architecture">
    <div class="architecture-content">
        <div class="architecture-images">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/arc1.jpg" alt="">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/arc2.jpg" alt="">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/arc3.jpg" alt="">
        </div>
        <div class="architecture-text">
            <h3>The Space</h3>
            <h1>Neo-Arabic Architecture</h1>
            <p>The design of Al-Jauhara is a contemporary homage to the Alhambra. Every corner has been conceived to
                provide privacy and visual wonder.</p>
            <div class="architecture-characteristics">
                <div class="characteristic">
                    <div class="characteristic-title">
                        <p>01.</p>
                        <h3>Zellige Mosaics</h3>
                    </div>
                    <div class="characteristic-text">Hand-cut glazed clay tiles by master craftsmen from Fez, creating
                        geometric patterns that invite meditation.</div>
                </div>
                <div class="characteristic">
                    <div class="characteristic-title">
                        <p>02.</p>
                    ...
                    <div class="characteristic-text">
                        Perforated brass lamps cast kaleidoscopic shadows on the Venetian stucco walls,
                        creating an intimate, golden atmosphere.
                    </div>
                </div>
                <div class="characteristic">
                    <div class="characteristic-title">
                        <p>03.</p>
                        <h3>Noble Materials</h3>
                    </div>
                    <div class="characteristic-text">Black Marquina marble tables, silk velvet seats and 24-karat gold
                        leaf details.</div>
                </div>
            </div>
        </div>
...
<section class="terrace">
  ...
  <div class="terrace-text">
    ...
    <a href="<?php echo esc_url(home_url('/table')); ?>" class="cta">Reserve Your Table</a>
  </div>
</section>
<section class="store">
    <div class="store-content">
        <div class="store-text">
            <h3>The Store</h3>
            <h1>Treasures of Bekaa's Valley</h1>
            <p>Our precisely climate-controlled underground cellar houses over 800 wines. While we offer the great
                European classics, our pride lies in our collection of Middle Eastern wines.
                <br><br>
                Discover historic verticals from Château Musar (since 1998), biodynamic gems from Domaine de Bargylus,
                and rare finds from small wineries in Cappadocia.
            </p>
            <div class="wine-cards">
                <div class="wine">
                    <svg fill="#630000" height="200px" width="200px" version="1.1" id="Capa_1"
...
<section id="menu">
    <div class="menu-intro">
        ...
        <!-- WINES SECTION -->
        <div class="cellar-intro">
            <h3>Sommelier Selection</h3>
            <h1>The Cellar</h1>
            <p>A curated collection of rare vintages from the Levant and beyond, selected to harmonize with the spices
                of our kitchen.</p>
        </div>
...
<section class="private-dining">
    <div class="private-dining-content">
        <div class="private-dining-text">
            ...
            <h1>In-Room Dining & Private Butler</h1>
            <div class="line"></div>
            <p>Experience the full grandeur of Al-Jauhara within the sanctuary of your private suite. Whether you desire
                a sunrise breakfast featuring fresh honeycomb and warm pita, or a late-night feast of Wagyu Kibbeh, our
                culinary team is at your command.
                <br><br>
                Our white-glove butler service ensures that every course is presented with the same ritualistic elegance
                as in our main dining hall, accompanied by our sommelier's selection of wines.
            </p>
            <div class="private-dining-features">
                <div class="dining-feature">
                    <div class="dining-logo"><svg width="64px" height="64px" viewBox="0 0 192 192"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <g transform="translate(16 16)">
                                    <circle cx="80" cy="80" r="74"
                                        style="fill:none;stroke:#ffffff;stroke-width:12;stroke-linejoin:round;stroke-opacity:1">
                                    </circle>
            ...
            <a href="/room-service" class="discover-link">View Room Service</a>
        </div>
