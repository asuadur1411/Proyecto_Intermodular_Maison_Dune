        ...
        <div class="split-right-content">
            <div class="content-inner-frame">
                ...
                <div class="split-links">
                    <a href="<?php echo esc_url(home_url('/contact')); ?>" class="discover-link">Book your stay</a>
                    <a href="<?php echo esc_url(home_url('/rooms-suites')); ?>" class="discover-link">Live Maison Dune</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="rooms-booking-wrapper">
    <section class="rooms-booking-banner">
    ...
    <div class="sticky-carousel-sticky">
        <div class="sticky-carousel-track" id="sticky-carousel-track">
            ...
            <div class="carousel-slide">
                ...
                <div class="image-col">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hotel-3.jpeg" alt="Sunset window view">
                </div>
            </div>
            ...
            <div class="carousel-slide">
                <div class="text-col">
                    <div class="text-inner">
                        ...
                        <p class="drop-cap">Each room has been forged to blur the faint boundary between our imposing interiors and the superb surrounding landscape. Contemplate the immensity in an intimate way.</p>

                        <div class="luxury-features-grid">
                            <div class="feature-box">
                                <h4>Equipped Terraces</h4>
                                <p>Outdoor areas with ergonomic furniture for in-room breakfasts.</p>
                            </div>
                            <div class="feature-box">
                                <h4>Hammam Bathrooms</h4>
                                <p>Rain showers and freestanding bathtubs over tadelakt textures.</p>
                            </div>
                            <div class="feature-box">
                                <h4>Climate Control</h4>
                                <p>Air purifiers and 100% silent automated thermostats.</p>
                            </div>
                            <div class="feature-box">
                                <h4>Adaptive Zones</h4>
                                <p>Reading areas with localized dim lighting and ample support.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/sticky-carousel.js?v=2.5"></script>
